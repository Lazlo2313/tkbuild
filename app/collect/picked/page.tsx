...
import getAllOrders from '../../lib/getPicked';
...
const Picked = () => {
  ...
  return (
    <div className="container mx-auto">
      <h1 className="text-3xl font-bold">Orders Picked</h1>
      ...
      <table className="container mx-auto bg-white">
        <thead className="bg-gray-100">
          <tr className="text-left">
            ...
            <th className=" md:table-cell py-2 px-4 border-b border-gray-200">Click & Collect</th>
          </tr>
        </thead>
        <tbody>
